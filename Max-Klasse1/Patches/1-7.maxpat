...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Einfacher als MIDI note number (für Menschen)",
					"linecount" : 2,
					"patching_rect" : [ 330.0, 100.0, 150.0, 34.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "kslider",
					"patching_rect" : [ 138.0, 2.0, 150.0, 20.0 ],
					"id" : "obj-1",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "kslider",
					"patching_rect" : [ 141.0, 36.0, 336.0, 53.0 ],
					"id" : "obj-11",
					"numinlets" : 2,
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ]
